// FlipBoard STIPPLE — phone side. Clay renders the settings page and, on save,
// auto-sends each value to the watch keyed by its messageKey. The custom theme
// function recolours Clay's accent to this face's colour (steel blue — e-paper grayscale).
